...
struct RecipeService {
    ...
    static let builtInRecipes: [RecipeTemplate] = [
        ...
        RecipeTemplate(name: "Write follow up email", icon: "envelope", prompt: "Draft a professional follow-up email for this meeting. Include: summary of what was discussed, action items with owners, next steps, and any decisions made. Keep it concise and actionable."),
